...
> 当前项目开发与本机使用入口已切换到 V3：双击 `启动 ANIMA V3.cmd`。当前功能与验收见 [v3/STATUS.md](v3/STATUS.md) 和 [2026-09-12 交付说明](docs/v3/NON_UI_RELEASE_20260912.md)。下方保留 V2 的历史使用及下载说明；V3 的本机发行构建位于 `release/`，不表示已经上传公开 Releases。
