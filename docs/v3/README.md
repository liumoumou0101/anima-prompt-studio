...
当前状态与入口：见 [V3 STATUS](../../v3/STATUS.md) 和 [2026-09-12 非视觉功能交付](NON_UI_RELEASE_20260912.md)。以下保留最初设计基线及文档索引，历史“尚未实现”描述不代表当前功能状态。

版本：V3.2-prep

日期：2026-08-25

本目录记录 V3 的设计和实现演变；当前事实以 STATUS 与最新交付记录为准。V3 保留 V2 已验证的本地翻译、资源管理、远程 ComfyUI 执行、任务恢复、凭据存储和画廊能力，实现新的提示词核心与本地 Web 工作台。
...
| [API_CONTRACT.md](API_CONTRACT.md) | 本地 API、核心对象、错误模型和会话安全；第 9 节为待实现的会话与参考库合同 |
| [CONVERSATIONAL_WORKBENCH.md](CONVERSATIONAL_WORKBENCH.md) | 2026-09-10 修订设计：逐轮要求、冻结提交、参考收藏、实施顺序与验收；尚未实现 |
...
| [WORKFLOW_MANAGEMENT_TODO.md](WORKFLOW_MANAGEMENT_TODO.md) | 工作流管理改造任务、实施依赖、迁移策略与发布验收标准 |
| [WORKFLOW_MANAGEMENT.md](WORKFLOW_MANAGEMENT.md) | 工作流管理操作指南、支持矩阵、迁移与贡献说明 |
...
| [DECISIONS.md](DECISIONS.md) | 已确定的架构决策记录；ADR-024 分轨原则，ADR-025 修订会话、资源与提交合同 |
