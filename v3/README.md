...
官方参考样例随 wheel 和 Windows 包携带。在经典工作台点击“试用会话创作”，展开“参考收藏”，即可点击“安装内置样例”启用木刻、炭笔、水彩三图包。此操作无需联网或调用模型，已有可用官方包不会被替换，个人笔记保留；也支持命令行安装，见 [官方参考样例包](example-packs/README.md)。
