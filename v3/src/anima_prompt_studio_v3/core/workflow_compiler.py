...
class V3WorkflowCompiler:
    ...
    def render(
        ...
        compatible_models = workflow_profile.compatible_model_profiles
        ...
        # Explicit job parameters always win, including historical recipe names.
        values.update({
